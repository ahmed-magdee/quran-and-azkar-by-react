export const classes = {
  input:
    "bg-transparent border border-white p-2 text-lg placeholder:text-[#ccc] rounded-md caret-green-header focus:outline-none focus:border-green-header",
  textarea:
    "h-[200px] resize-none bg-transparent border border-white placeholder:text-[#ccc] focus:outline-none focus:border-green-header p-2 rounded-md caret-green-header",
  submit:
